...
const NavLink: React.FC<NavItem> = ({ label, href, icon, isActive }) => (
  ...
  >
    <Link 
      href={href}
      className={`flex items-center space-x-[8px] px-[12px] py-[8px] rounded-md transition-colors duration-200 ${
  ...
  >
    ...
    <SignedOut>
      <Button asChild variant="default" size="sm">
        <Link href="/sign-in">
          <LogIn className="mr-[8px] h-[16px] w-[16px]" />
          Login
        </Link>
      </Button>
    </SignedOut>
...
const Header: React.FC = () => {
  ...
  return (
    <motion.header 
      ...
      role="banner"
    >
      <div className="container mx-auto px-[16px] sm:px-[24px] lg:px-[32px]">
        <div className="flex justify-between items-center py-[16px]">
          ...
          <nav className="hidden md:!flex items-center space-x-[16px]" role="navigation">
            <ul className="flex space-x-[16px] items-center">
